        ...
        if upsampling_mode == 'transpose':
            net += [nn.ConvTranspose2d(in_channels,
                    ...
                    nn.ConvTranspose2d(in_channels,
                                       out_channels,
                                       kernel_size=1)]
        # don't need to change any of these since don't have learnable parameters
...
class DownBlock(nn.Module):
    ...
    All convolutions are implemented with depthwise convolutions followed by 1x1 pointwise convolutions
    '''
